...
var req = new Test();
eval(String(req.functionCall()));

try{
    alert(com.isEmpty(dtm1.value));
    if(com.isEmpty(dtm1.value)){
        dtm1.value = com.formatDate(new Date, "dd-MMM-yyyy");
        //dtm1.value = new java.util.Date();
    }
}catch(e){
    alert(e);
}
